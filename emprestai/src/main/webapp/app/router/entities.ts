...
const BookDetails = () => import('@/entities/book/book-details.vue');
// prettier-ignore
const OwnerProcessDetails = () => import('@/entities/owner-process/owner-process-details.vue');
// prettier-ignore
const OwnerProcessList = () => import('@/entities/owner-process/owner-process-list.vue');
// prettier-ignore
...
export default [
  ...
  {
    path: '/process-definition/OwnerProcess/instance/:processInstanceId/view',
    name: 'OwnerProcessView',
    component: OwnerProcessDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/OwnerProcess/instances',
    name: 'OwnerProcessList',
    component: OwnerProcessList,
    meta: { authorities: [Authority.USER] },
  },
  {
