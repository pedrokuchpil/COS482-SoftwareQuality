...
class UsuarioResourceIT {
    ...
    public static Usuario createEntity(EntityManager em) {
        Usuario usuario = new Usuario().username(DEFAULT_USERNAME);
        return usuario;
    }
    ...
    public static Usuario createUpdatedEntity(EntityManager em) {
        Usuario usuario = new Usuario().username(UPDATED_USERNAME);
        return usuario;
    }
    ...
    void putNewUsuario() throws Exception {
        ...
        updatedUsuario.username(UPDATED_USERNAME);
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.username(UPDATED_USERNAME);
